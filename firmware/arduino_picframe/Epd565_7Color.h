...
class Epd565_7Color {
 public:
  ...
  static constexpr size_t kFramebufferBytes = (kWidth * kHeight) / 2;  // 4bpp packed

  Epd565_7Color(uint8_t busyPin, uint8_t rstPin, uint8_t dcPin, uint8_t csPin,
                uint8_t sckPin, uint8_t mosiPin, SPIClass& spi = SPI);
